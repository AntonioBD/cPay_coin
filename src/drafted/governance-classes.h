 ...
 *
 *   // network
 *   CcPayNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.cpay.click/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CcPayNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: cPayNetwork
// //   -- signature requirements : Key1(User)
// class CcPayNetworkVariable : public CGovernanceObject
// {
// private:
