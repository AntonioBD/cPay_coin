...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "cPayNetwork") type = cPayNetwork;
    if(strType == "cPayNetworkVariable") type = cPayNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == cPayNetwork) s = "cPayNetwork";
    if(type == cPayNetworkVariable) s = "cPayNetworkVariable";
