...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("cpay.click", "dnsseed.cpay.click"));
        vSeeds.push_back(CDNSSeedData("cpaydot.io", "dnsseed.cpaydot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("cpaypay.io", "dnsseed.cpaypay.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("cpaydot.io",  "testnet-seed.cpaydot.io"));
