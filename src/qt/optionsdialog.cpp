    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CPAY-light"), QVariant("light"));
    ui->theme->addItem(QString("CPAY-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CPAY-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CPAY-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CPAY-traditional"), QVariant("trad"));
