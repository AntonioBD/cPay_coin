    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextcPay   = QChar(0xA9)+ QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The cPay Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+24,copyrightTextcPay);
