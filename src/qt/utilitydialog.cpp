    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("cPay Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About cPay Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cpay-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the cPay in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CPAY, 0.1 CPAY, 1 CPAY and 10 CPAY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cpaypay.atlassian.net/wiki/display/DOC/PrivateSend\">https://cpaypay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("cPay Core is shutting down...") + "<br /><br />" +
