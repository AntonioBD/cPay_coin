...
This mechanism has been integrated into Bitcore-Node-cPay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cpaypay/insight-api-cpay#web-socket-api](https://github.com/cpaypay/insight-api-cpay#web-socket-api)
* API: [https://github.com/cpaypay/insight-api-cpay#instantsend-transactions](https://github.com/cpaypay/insight-api-cpay#instantsend-transactions)
...
By default, the cPay Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the cPay Core daemon:
